(() => {
        ...
        paralaxMouseInit(paralaxMouse) {
            paralaxMouse.forEach((el => {
                ...
                function setMouseParallaxStyle() {
                    ...
                    positionX += distX * paramAnimation / 4e3;
                    positionY += distY * paramAnimation / 4e3;
    ...
    function initSliders() {
        if (document.querySelector(".products__swiper")) new swiper_core_Swiper(".products__swiper", {
        ...
        if (document.querySelector(".review__swiper")) new swiper_core_Swiper(".review__swiper", {
            modules: [ Navigation, Autoplay, Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
